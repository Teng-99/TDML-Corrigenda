...
|===
|Requirement 17 |/req/aitrainingdataset/trainingdata
...
[width="100%",cols="20%,80%",]
|===
|Requirement 18 |/req/aitrainingdataset/trainingtypecode
...
[width="100%",cols="20%,80%",]
|===
|Requirement 19 |/req/aitrainingdataset/eotrainingdata
...
Example:

 {
   ...
   "dataTime": ["2002-05-30T09:30:10Z"],
   "dataURL": ["image/Airport/airport_01.jpg"],
   "spatialResolution": {"distance":{"value": "0.5", "uom": "m"}},
   "labels": [{"type": "AI_SceneLabel", "class": "Airport"}]
 }
